...
const FileManager = () => {
    ...
    return (
        <div className="file-manager">
            ...
            <div className="row">
                <div className="column">
                    ...
                    <input
                        ...
                        placeholder="C:\Users\User\OneDrive\Projects\FileManager"
                    />
            ...
            <div className="row">
                <div className="column">
                    <h2>Top 10 Words in File</h2>
                    <p>Compute the 10 words by frequency in the specified file using multiple threads and display them.</p>
